...
//                 const res = await supabase.from('asset_analysis_master').select('*')
...
//                 const resgetallasset = await supabase.from('assets_master').select('*')
...
//                 const resgetallassetcomponent = await supabase.from('assets_component_master').select('*')
    ...
    return (
        <div style={{
            ...
            <div style={{ position: 'relative', zIndex: 2, maxWidth: '2000px', margin: '0 auto' }}>
                ...
                {/* Filters Bar - Modern Responsive Layout */}
                <div style={{
                    position: 'relative',
                    zIndex: 2,
                    background: 'rgba(255,255,255,0.03)',
