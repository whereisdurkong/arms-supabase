...
//                         <thead>
//                             <tr style={{ background: '#1E293B', borderBottom: '1px solid #E9EDF2' }}>
//                                 {[
...
//                                 ].map(col => (
//                                     <th key={col.field} style={{ padding: '14px 20px', textAlign: 'left', fontSize: '0.7rem', fontWeight: '600', color: '#ffffff', textTransform: 'uppercase', letterSpacing: '0.5px', cursor: 'pointer' }} onClick={() => handleSort(col.field)}>
...
//                                     </th>
//                                 ))}
//                                 <th style={{ padding: '14px 20px', textAlign: 'right', fontSize: '0.7rem', fontWeight: '600', color: '#ffffff', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Actions</th>
//                             </tr>
//                         </thead>
//                         <tbody>
//                             {loading ? (
...
//                                             <button onClick={() => handleView(asset)} style={{
...
export default function SetupAllOptions() {
    ...
    // Fixed: Better way to open date picker with fallback
    const openDatePicker = (inputRef) => {
        if (inputRef.current) {
            ...
            // Fallback: click the input directly
                ...
                // For some browsers, we need to focus first
                ...
                <div style={{
                    ...
                    <div style={{ display: 'flex', flexWrap: 'wrap', gap: '16px', alignItems: 'center', justifyContent: 'space-between' }}>
                        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '12px', flex: 1 }}>
                            {/* Search Input */}
                            <div style={{
                                display: 'flex', alignItems: 'center', background: 'rgba(0,0,0,0.3)', borderRadius: '40px', padding: '8px 16px', gap: '8px', minWidth: '240px', flex: 2,
                            ...
                            >
                                ...
                                />
                                <span
                                    style={{ color: 'rgba(255,255,255,0.4)', fontSize: '0.8rem', cursor: 'pointer' }}
                    ...
                    <table style={{ width: '100%', borderCollapse: 'collapse', minWidth: '1000px' }}>
                        <thead>
                            <tr style={{ background: '#1E293B', borderBottom: '1px solid #E9EDF2' }}>
                                ...
                                <th style={{ padding: '2px 20px', textAlign: 'right', fontSize: '0.7rem', fontWeight: '600', color: '#ffffff', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Actions</th>
                            </tr>
                        </thead>
                        <tbody>
                            {loading ? (
...
/* Make sure the input itself doesn't show the default icon */
input[type="date"] {
